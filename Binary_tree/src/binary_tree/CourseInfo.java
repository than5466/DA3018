...
public class CourseInfo {
	 ...
	 * 
	 * } if (args.length == 2) { BinarySearchTree.BSTNode g; g = BST.find(args[1]);
	 * if (g == null) { System.out.
	 ...
	 * 
	 * } else { for (BinarySearchTree.BSTNode node : BST) {
	 * System.out.printf("%-8s", node.getCourseCode()); System.out.printf("%-20s",
	 * node.getCourseName()); System.out.printf("%6s%n", node.getCredits()); Sum +=
	 * node.getCredits(); } System.out.printf("%-28s", "Summa: ");
	 * System.out.printf("%6s%n", Sum); } } else { System.out.
